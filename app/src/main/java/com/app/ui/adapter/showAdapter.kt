...
import com.app.ui.fragment.showFragment
import com.bumptech.glide.Glide
import java.lang.StringBuilder

class showAdapter(private val newsList: List<News>, private val newsFragment: showFragment) :
    RecyclerView.Adapter<showAdapter.BaseViewHolder>() {
    companion object {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        if (holder is NewsViewHolder) {
            ...
            holder.itemView.setOnClickListener {
                ...
                intent.putExtra("collect?",currentNews.collect)
