...
class HomeFragment : Fragment() {
    ...
    // List类型,shehui(社会),guonei(国内),guoji(国际),yule(娱乐),tiyu(体育)junshi(军事),keji(科技),caijing(财经),shishang(时尚)
    ...
    //生命周期中若onCreate()执行，会调用onActivityCreated()函数
